...
#ifndef SMARTTAB_SWIFT_H
#define SMARTTAB_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SmartTab",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8SmartTab11AppDelegate")
...
SWIFT_CLASS("_TtC8SmartTab15KeyHandlingView")
...
@class NSWindow;
SWIFT_CLASS("_TtC8SmartTab24LauncherWindowController")
@interface LauncherWindowController : NSWindowController <NSWindowDelegate>
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
